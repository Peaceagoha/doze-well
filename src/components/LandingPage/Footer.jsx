    ...
    <footer className="bg-purple-dark-dozewell mx-auto w-full px-6 py-10 sm:px-20 sm:py-24 text-white space-y-6">
      <section className="container mx-auto">
        ...
        <div className="flex flex-col sm:flex-row justify-between mb-8">
          ...
          {/* Links Section */}
          <main className="flex flex-col md:flex-row md:justify-between md:mt-0 mt-10 gap-8 items-start">
            {/* Links */}
        ...
        <div className="flex md:justify-end justify-start gap-6 mt-10 sm:mt-12">
