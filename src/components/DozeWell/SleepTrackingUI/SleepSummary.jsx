        ...
        <div className="space-y-6">
          ...
          <ResponsiveContainer width="100%" height={300}>
            ...
            >
              ...
              <Tooltip
                ...
                contentStyle={{ backgroundColor: "transparent", color: "#fff" }}
              />
              <Area
                dataKey="stage"
                stroke="#6a5acd"
          ...
          >
            <div className="flex items-center space-x-2 bg-purple-dozewell-accent rounded-lg shadow-lg py-2 px-3 sm:py-3 sm:px-8 text-white">
              ...
              <div>
                <div className="font-semibold text-sm sm:text-base">40min</div>
            ...
            <div className="flex items-center space-x-2 bg-purple-dozewell-accent rounded-lg shadow-lg py-2 px-3 sm:py-3 sm:px-8 text-white">
              ...
              <div>
                <div className="font-semibold text-sm sm:text-base">35min</div>
                <div className="text-xs sm:text-sm text-gray-500">
                  Sleep Interrupted
                </div>
              </div>
