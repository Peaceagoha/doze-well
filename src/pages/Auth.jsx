            ...
            <aside className="w-full md:w-1/2 flex flex-col items-center">
              ...
              <form className="w-full max-w-md flex flex-col gap-4">
                ...
                <button
                  ...
                  className="bg-purple-dozewell text-gray-light-dozewell py-3 rounded-lg text-lg"
                >
                  Create an Account
                </button>
            ...
            <div className="fixed inset-0 bg-purple-dozewell-light bg-opacity-75 flex items-center justify-center z-50">
              <div className="bg-black text-white rounded-lg shadow-lg p-8 w-full max-w-md relative">
                ...
                <form>
                  ...
                  <button
                    onClick={handleLogin}
                    className="w-full bg-purple-dozewell text-gray-light-dozewell hover:bg-purple-700 text-white py-3 rounded-lg mt-6"
                  >
                    Login
                  </button>
