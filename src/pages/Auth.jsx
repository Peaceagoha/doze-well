  ...
  return (
    <>
      <section className="flex flex-col items-center justify-start bg-bg-primary h-fit">
        <header className="text-dozwell-green w-full text-left px-5 py-5 md:px-11 md:py-4 text-3xl font-bold">
          DozeWell
        </header>
          ...
          <div className="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
            ...
            <div className="mt-4 md:mt-0">
              ...
              <p className="mb-6 font-light text-gray-light-dozewell md:text-lg">
                DozeWell provides a comprehensive collection of calming sounds,
        ...
        <section className="">
          <div className="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:flex md:flex-row-reverse sm:py-16 lg:px-6">
            ...
            <div className="mt-4 md:mt-0">
              ...
              <p className="mb-6 font-light text-gray-light-dozewell md:text-lg">
                DozeWell smart alarm, together with its carefully designed alarm
                sounds, wakes you up gently during your lightest sleep phase,
                helping you feel more rested and recovered to face the day
                ahead.
              </p>
            </div>
          </div>
        ...
        <section className="">
          <div className="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
            ...
            <div className="mt-4 md:mt-0">
              ...
              <p className="mb-6 font-light text-gray-light-dozewell md:text-lg">
                While you are asleep, DozeWell uses it’s patented sound analysis
                to map your sleep patterns and sleep environment. Find out
                everything from how much sleep to how much you snore or cough
                during the night.
              </p>
            </div>
          </div>
